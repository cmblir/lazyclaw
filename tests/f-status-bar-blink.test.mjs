...
const t = { accent: (s) => `A:${s}`, dim: (s) => `D:${s}` };
...
test('streaming pulses the dot between bright and dim', () => {
  assert.equal(streamingIndicator(true, true, t), 'A:● streaming');   // bright phase
