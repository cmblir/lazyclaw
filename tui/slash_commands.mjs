...
export const SLASH_COMMANDS = [
  ...
  { cmd: '/provider',    help: 'pick provider from a list (or pass a name: /provider openai)', arg: { name: 'provider', completer: 'provider' } },
  { cmd: '/login',       help: 'connect a keyless CLI provider (codex-cli / gemini-cli): browser, API key, or install' },
  { cmd: '/model',       help: 'pick a model from a list (or pass a name: /model gpt-4.1)', arg: { name: 'model', completer: 'model' } },
  { cmd: '/hud',         help: 'toggle the HUD status row (usage · models · cost): /hud on|off' },
  { cmd: '/trainer',     help: 'view or set trainer provider/model: /trainer show|set <p:m>|clear', arg: { name: 'spec', completer: 'trainerSpec', after: ['set', 'fallback'] } },
  ...
  { cmd: '/orchestrator', help: 'multi-agent: status | on | off | planner <spec> | worker add|remove <spec>', arg: { name: 'spec', completer: 'orchestratorSpec', after: ['planner', 'worker'] } },
  ...
  { cmd: '/agent',       help: 'spawn or switch agent: /agent NAME (edit <name> picks provider/model)', arg: { name: 'name', completer: 'agentName', after: ['edit', 'show', 'remove'] } },
