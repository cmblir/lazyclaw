...
export const SLASH_COMMANDS = [
  ...
  { cmd: '/agent',       help: 'agents: list · show <name> · add <name> [--provider p] [--model m] [role] · edit <name> · remove <name>' },
  { cmd: '/team',        help: 'teams: list · show <name> · add <name> --agents a,b [--lead a] · member add|remove <team> <agent> · remove <name>' },
  { cmd: '/task',        help: 'multi-agent tasks: start/tick/list/show/transcript/abandon/done/remove' },
  { cmd: '/workflow',    help: 'stored workflows: run|resume|clear <name>' },
