...
const INSTALLED = Symbol.for('pompos.gateway.crashHandlers');

export function installCrashHandlers({ label = 'pompos', logger = null, stop = null, exit = null } = {}) {
